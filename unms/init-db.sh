...
UNMS_POSTGRES_DB="${POSTGRES_DB:-unms}"
UNMS_POSTGRES_SCHEMA="${UNMS_POSTGRES_SCHEMA:-unms}"
UNMS_POSTGRES_USER="${POSTGRES_USER:-unms}"
UNMS_POSTGRES_PASSWORD="${POSTGRES_PASSWORD:-unms}"

UCRM_POSTGRES_SCHEMA="${UCRM_POSTGRES_SCHEMA:-ucrm}"
UCRM_POSTGRES_USER="${UCRM_POSTGRES_USER:-ucrm}"
UCRM_POSTGRES_PASSWORD="${POSTGRES_PASSWORD:-ucrm}"
